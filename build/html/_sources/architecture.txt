...
On this section, we give an overview of the NUBOMEDIA architecture, with special emphasis
on the part of computer vision.

Let's start with a simple explanation of what NUBOMEDIA is. Imagine a media communication
...
At this point, we can differenciate two parts the client part which  runs in the browser
...
Therefore we can distinguish three different modules:
...
The main technologies used for this architecture are: `OpenStack <https://www.openstack.org>`__, `Kurento <http://www.kurento.org>`__ and different techniques that make it possible  
to develop the different features of the filters.
...
Now, we are going to see how to integrate these algorithms and how to  process the video and data.
...
develop  VCA filters contained on the media elements.
...
Finally, once the algorithm has been developed and installed, the developers can use 
the filter using the Java or JavaScript API.
