...
By default, this demos use a local Kurento Media Server with the proper filter
installed. The available tutorials are the following:

- :doc:`Ear detector <ear_detector>`. This web application consists on a
  WebRTC video communication with a **ear detector filter**. To run this
  tutorial from the source code:
...
- :doc:`Eye detector <eye_detector>`. This web application consists on a
  WebRTC video communication with a **eye detector filter**. To run this
  tutorial from the source code:
...
- :doc:`Face detector <face_detector>`. This web application  consists on a
  WebRTC video communication with a **face detector filter**. To run this
  tutorial from the source code:
...
- :doc:`Face profile <face_profile>`. This web application consists on a
  ...
  **face, mouth, nose and eye detector filter**. To run this tutorial from the
  source code:
...
- :doc:`Nose detector <nose_detector>`. This web application consists on a
  WebRTC video communication with a **nose detector filter**. To run this
  tutorial from the source code:
...
- :doc:`Tracker <tracker>`. This web application  consists on a WebRTC video
  communication with a **tracker detector filter**. To run this tutorial from
  the source code:
