...
we can test the application accesing the following URL: **localhost:8108**
...
.. sourcecode:: console
   ...
   java -jar target/NuboEyeJava*.jar
...
.. image:: images/eye_detector.png
   :alt:    eye detector application
   :align:  center
   :width:  640
...
.. image:: images/eye_pipeline.png
   :alt:    eye detector pipeline
   :align:  center
   :width:  480
...
.. image:: images/EyeJavaClass.png
   :alt:    eye detector class diagram
   :align:  center
   :width:  480

The main class of this demo is named NuboEyeJavaApp. As you can see, the NuboMediaClient
...
a WebSocketHanlder to process WebSocket requests in the path /nuboeyedetector.

NuboEyeJavaHandler class implements TextWebSocketHandler to handle text WebSocket requests.
...
start, show_eyes, scale_factor, process_num_frames, width_to_process,  stop and onIceCandidates.
...
creates a Media Pipeline, creates the Media Elements (WebRtcEndpoint and NuboEyeDetectorFilter) 
...
/nuboeyedetector. Then, the onmessage listener of the WebSocket is used to implement the 
