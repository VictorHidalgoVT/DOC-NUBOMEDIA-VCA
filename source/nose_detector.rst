...
This web application  consists on a WebRTC video communication with a nose
...
application accesing the following URL: **localhost:8102**
...
The main class of this demo is named NuboNoseJavaApp. As you can see, the
...
requests in the path /nubonosedetector.

NuboNoseJavaHandler class implements TextWebSocketHandler to handle text
...
the Server: start, show_noses, scale_factor, process_num_frames,
...
(WebRtcEndpoint and NuboNoseDetectorFilter) and make the connections among
...
(variable ws) in the path /nubonosedetector. Then, the onmessage listener of
