...
we can test the application accesing the following URL: **localhost:8102**
...
.. sourcecode:: console
   ...
   java -jar target/NuboNoseJava*.jar
...
.. image:: images/nose_detector.png
   :alt:    nose detector application
   :align:  center
   :width:  640
...
.. image:: images/nose_pipeline.png
   :alt:    nose detector pipeline
   :align:  center
   :width:  480
...
.. image:: images/NoseJavaClass.png
   :alt:    nose detector class diagram
   :align:  center
   :width:  480

The main class of this demo is named NuboNoseJavaApp. As you can see, the NuboMediaClient
...
a WebSocketHanlder to process WebSocket requests in the path /nubonosedetector.

NuboNoseJavaHandler class implements TextWebSocketHandler to handle text WebSocket requests.
...
start, show_noses, scale_factor, process_num_frames, width_to_process,  stop and onIceCandidates.
...
creates a Media Pipeline, creates the Media Elements (WebRtcEndpoint and NuboNoseDetectorFilter) 
...
/nubonosedetector. Then, the onmessage listener of the WebSocket is used to implement the 
...
handled with `Bower <http://bower.io/>`_. This dependencies are defined in the file
